...
The study case consists of paired-end strand-oriented RNA-seq samples from the mouse *Mus musculus*. In order to ensure a quick treatment for this tutorial, we selected the subset of reads restricted to a 30Mb region located on the mouse chromosome 18 (a small chromosome). 
