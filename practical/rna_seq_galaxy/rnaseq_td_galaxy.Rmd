...
<div class="protocol">
- Select **Shared Data > Data Libraries > P5424_chr18-20Mto50M > GTF >  chr18_20M-50M_gencode_vM1.gtf > Import this dataset into selected history**. In the new window select **DM1** as **Destination history**. Click on **Import library dataset**.
...
- Download the tophat result files from Galaxy to your computer: 
    ...
    - Select tophat result (bam format) and download the **bai** file.
    - Select tophat result (**control_splice_junctions.bed**) and download the **bed** file. If this file does not contain a **bed** extension, rename it to add **.bed**.

- Open a connection to the Integrative Genomics Viewer (**IGV**) download page:
	<https://software.broadinstitute.org/software/igv/download>
- Download and open IGV or launch it with 750 MB or 1.2 Gb depending of your machine.
- Select **mm9** as a genome and browse to **chromosome 18**. 

    - **Do not** check the option "Download sequences", because this would download several Gb of genomic sequences on your computer, which would take time and mobilise disk pace unnecessarily. 
...
- Select the **tophat2 accepted hits** in the **SAM or BAM file of aligned RNA-Seq reads** menu.
